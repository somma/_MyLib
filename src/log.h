...
#define log_msg     log_write_fmt_without_deco( log_mask_sys, log_level_warn, log_to_ods | log_to_file, 
...
#define con_msg     log_write_fmt_without_deco( log_mask_sys, log_level_warn, log_to_con, 
