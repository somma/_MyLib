...
bool match_string(const string& text, const string& wild)
{
	size_t i = 0;
	size_t j = 0;
	size_t n = text.size();
...
bool glob_match_string(const string& text, const string& glob)
{
	size_t i = 0;
	size_t j = 0;
	size_t n = text.size();
...
bool gitignore_glob_match_string(const string& text, const string& glob)
{
	size_t i = 0;
	size_t j = 0;
	size_t n = text.size();
