...
#define _file_time_to_msec  ((int64_t) 10000)
#define _file_time_to_sec   ((int64_t) 10000000)
...
FILETIME unixtime_to_filetime(_In_ uint64_t unix_time);
...
// 
// For cross-session process creation, use ProcessLauncher module:
//   #include "ProcessLauncher.h"
//   launch_process(launcher_privilege_level::user_privilege, session_id, cmdline);
//
// For local process creation (current session/privilege):
//   launch_process_local(cmdline, flags, working_dir, handle, pid);
//   launch_process_local_and_wait(cmdline, flags, working_dir, timeout, exit_code);
//=============================================================================
